...
The notebook is built to work with datasets such as KDD-CUP99, CICIDS2017, and CICMalMem2022. It also supports both binary and multiclass classification, depending on the dataset and task configuration.
